...
export default [
  ...
  
  {
    ...
    routes: [
      ...
      },
      {
        ...
        name: 'Album Detail',
        hideInMenu: true,
        component: './YouPhoto/Album/Detail',
      },
      // {
      //   access: 'youphoto',
      //   path: 'lora/list',
  ...
  },
  {
    ...
    routes: [
      ...
      {
        access: 'youmusic',
        path: '/youmusic/artist/list',
        name: 'Artist Management',
        icon: 'user',
        component: './YouMusic/Artist/List',
      },
      {
        access: 'youmusic',
        path: '/youmusic/artist/detail/:id',
        name: 'Artist Detail',
        hideInMenu: true,
        component: './YouMusic/Artist/Detail',
      },
      {
        access: 'youmusic',
        path: '/youmusic/tag/list',
        name: 'Tag Management',
        icon: 'tag',
        component: './YouMusic/Tag/List',
      },
    ],
  },
  {
